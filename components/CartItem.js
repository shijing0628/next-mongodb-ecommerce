        ...
        <tbody>
          <tr>
            <td style={{ width: '100px', overflow: 'hidden' }}>
              <img src={item.images[0].url} alt={item.images[0].url} className="img-thumbnail w-100"
            ...
            <td className="align-middle" style={{ minWidth: '60px', cursor: 'pointer' }}>
              <i className="fas fa-trash-alt" aria-hidden="true" style={{ fontSize: '18px', color: 'tomato' }} data-toggle="modal" data-target="#exampleModal"
                onClick={() => dispatch({
                  type: 'ADD_MODAL',
